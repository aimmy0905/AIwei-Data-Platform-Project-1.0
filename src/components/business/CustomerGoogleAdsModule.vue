<template>
  <div class="customer-google-ads-module analysis-module">
    <!-- 模块头部 -->
    <div class="analysis-module__header">
      <h3 class="analysis-module__title">客户Google广告数据总览</h3>
    ...
    <div v-else class="analysis-module__content">
      <!-- 数据表格 -->
      <div class="google-ads-table-container">
        <table class="google-ads-table">
          ...
          <tbody>
            <tr
              v-for="(customer, index) in googleAdsData"
...
// 模拟Google广告数据
const googleAdsData = ref<GoogleAdsData[]>([
  {
    customerId: '1',
    ...
    alerts: [
      { type: 'CPC异常', severity: 'medium', message: 'CPC较上周上涨25%' }
    ]
  },
  {
    customerId: '2',
  ...
  },
  {
    ...
    optimizer: '优化师3',
    spend: 156000,
    conversionValue: 620000,
    conversionValueByTime: 595000,
    roas: 4.0,
    roasByTime: 3.8,
    conversions: 320,
    conversionRate: 2.5,
    ...
    estimatedDaysLeft: 8,
    alerts: [
      { type: '花费异常', severity: 'high', message: '日花费超出预算20%' },
      { type: '转化异常', severity: 'low', message: '转化率较上月下降5%' }
    ]
  },
  {
    customerId: '4',
    ...
    optimizer: '优化师1',
    spend: 87500,
    conversionValue: 315000,
    conversionValueByTime: 298000,
    roas: 3.6,
    roasByTime: 3.4,
    conversions: 210,
    conversionRate: 2.9,
  ...
  },
  {
    ...
    optimizer: '优化师2',
    spend: 75000,
    conversionValue: 240000,
    conversionValueByTime: 228000,
    roas: 3.2,
    roasByTime: 3.0,
    conversions: 180,
    conversionRate: 2.4,
    ...
    alerts: [
      { type: 'CPC异常', severity: 'low', message: 'CPC较行业平均偏低15%' }
    ]
  }
])
