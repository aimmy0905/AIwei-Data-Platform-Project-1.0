<template>
  <div class="customer-bing-ads-module analysis-module">
    <!-- 模块头部 -->
    <div class="analysis-module__header">
      <h3 class="analysis-module__title">客户Bing广告数据总览</h3>
    ...
    <div v-else class="analysis-module__content">
      <!-- 数据表格 -->
      <div class="bing-ads-table-container">
        <table class="bing-ads-table">
          <thead>
            <tr>
          ...
          <tbody>
            <tr
              v-for="(customer, index) in bingAdsData"
...
// 模拟Bing广告数据
const bingAdsData = ref<BingAdsData[]>([
  {
    customerId: '1',
  ...
  },
  {
    ...
    optimizer: '优化师3',
    spend: 52000,
    conversionValue: 215000,
    conversionValueByTime: 205000,
    roas: 4.1,
    roasByTime: 3.9,
    conversions: 155,
    conversionRate: 3.2,
    ...
    cpc: 13.0,
    cpa: 335.5,
    estimatedDaysLeft: 27,
    alerts: [
      { type: '转化异常', severity: 'low', message: 'Bing转化表现稳定上升' }
    ]
  },
  {
    customerId: '3',
    ...
    optimizer: '优化师2',
    spend: 98000,
    conversionValue: 445000,
    conversionValueByTime: 425000,
    roas: 4.5,
    roasByTime: 4.3,
    conversions: 235,
    conversionRate: 3.6,
    ...
    cpc: 15.1,
    cpa: 416.8,
    estimatedDaysLeft: 13,
    alerts: [
      { type: 'CPC异常', severity: 'medium', message: 'Bing CPC较上月上涨12%' }
    ]
  },
  {
    customerId: '4',
    ...
    optimizer: '优化师1',
    spend: 45000,
    conversionValue: 195000,
    conversionValueByTime: 188000,
    roas: 4.3,
    roasByTime: 4.2,
    conversions: 125,
    conversionRate: 3.1,
  ...
  },
  {
    ...
    cpc: 10.6,
    cpa: 361.9,
    estimatedDaysLeft: 38,
    alerts: [
      { type: '花费异常', severity: 'high', message: 'Bing广告日预算使用率偏低' }
    ]
  }
])
