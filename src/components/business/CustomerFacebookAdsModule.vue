<template>
  <div class="customer-facebook-ads-module analysis-module">
    <!-- 模块头部 -->
    <div class="analysis-module__header">
      <h3 class="analysis-module__title">客户FB广告数据总览</h3>
    ...
    <div v-else class="analysis-module__content">
      <!-- 数据表格 -->
      <div class="facebook-ads-table-container">
        <table class="facebook-ads-table">
          <thead>
            <tr>
          ...
          <tbody>
            <tr
              v-for="(customer, index) in facebookAdsData"
...
// 模拟Facebook广告数据
const facebookAdsData = ref<FacebookAdsData[]>([
  {
    customerId: '1',
    customerName: '华为技术有限公司',
    optimizer: '优化师2',
    spend: 145000,
    conversionValue: 520000,
    conversionValueByTime: 495000,
    roas: 3.6,
    roasByTime: 3.4,
    conversions: 310,
    conversionRate: 3.1,
    ...
    alerts: [
      { type: '花费异常', severity: 'high', message: 'FB广告花费较上周增长30%' }
    ]
  },
  {
    customerId: '2',
  ...
  },
  {
    ...
    optimizer: '优化师3',
    spend: 178000,
    conversionValue: 695000,
    conversionValueByTime: 668000,
    roas: 3.9,
    roasByTime: 3.8,
    conversions: 355,
    conversionRate: 2.8,
    ...
    estimatedDaysLeft: 6,
    alerts: [
      { type: 'CPC异常', severity: 'medium', message: 'FB广告CPC较行业平均高18%' },
      { type: '转化异常', severity: 'low', message: '转化率较上月提升8%' }
    ]
  },
  {
    customerId: '4',
  ...
  },
  {
    ...
    optimizer: '优化师1',
    spend: 85000,
    conversionValue: 285000,
    conversionValueByTime: 272000,
    roas: 3.4,
    roasByTime: 3.2,
    conversions: 195,
    conversionRate: 2.6,
    ...
    alerts: [
      { type: '转化异常', severity: 'medium', message: 'FB转化率较目标低12%' }
    ]
  }
])
...
.facebook-ads-table th,
.facebook-ads-table td {
  padding: 12px 8px;
