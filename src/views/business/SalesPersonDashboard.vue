        ...
        <div v-if="annualQuarterlyTargets" class="annual-quarterly-targets">
            <div class="targets-table-container">
              ...
              <tbody>
                ...
                <!-- 季度行 -->
                <tr v-for="quarter in quarterlyData" :key="quarter.name" class="quarterly-row">
                  <td>{{ quarter.name }}</td>
...
const quarterlyData = ref([
  { name: '合计', serviceFeeTarget: 21000000, serviceFeeActual: 19950000, serviceFeeCompletion: 95.0, newOrderTarget: 126, newOrderActual: 108, newOrderCompletion: 85.7 },
  { name: 'Q1', serviceFeeTarget: 6000000, serviceFeeActual: 5700000, serviceFeeCompletion: 95.0, newOrderTarget: 36, newOrderActual: 31, newOrderCompletion: 86.1 },
  { name: 'Q2', serviceFeeTarget: 5500000, serviceFeeActual: 5225000, serviceFeeCompletion: 95.0, newOrderTarget: 33, newOrderActual: 28, newOrderCompletion: 84.8 },
  { name: 'Q3', serviceFeeTarget: 5000000, serviceFeeActual: 4750000, serviceFeeCompletion: 95.0, newOrderTarget: 30, newOrderActual: 26, newOrderCompletion: 86.7 },
  { name: 'Q4', serviceFeeTarget: 4500000, serviceFeeActual: 4275000, serviceFeeCompletion: 95.0, newOrderTarget: 27, newOrderActual: 23, newOrderCompletion: 85.2 }
])
